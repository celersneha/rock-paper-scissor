        ...
        <div className="bg-surface-raised rounded-2xl p-8 w-full max-w-sm text-center space-y-6">
          ...
          <div className="bg-surface-over rounded-xl py-6">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button onClick={() => { navigator.clipboard.writeText(room.code); toast('Copied!', 'success') }}
                className="text-text-muted hover:text-text transition-colors p-1" title="Copy room code">
